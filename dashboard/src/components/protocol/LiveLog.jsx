...
const colors = {
  ...
  REKEY_ACK: "text-yellow-300",
  KEY_ROTATION: "text-amber-400",
  RESUME: "text-pink-400",
  SESSION_RESUME: "text-pink-400",
  SESSION_RESUME_ACK: "text-pink-300",
  FORWARD_SECRECY: "text-teal-300",
  SESSION_CACHE: "text-slate-400",
  SESSION_STORE: "text-slate-400",
  PING: "text-sky-400",
  PONG: "text-sky-300",
  ERROR: "text-red-500",
};
